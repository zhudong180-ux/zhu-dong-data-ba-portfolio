...
def _process_template(input_path, output_path, columns_to_join=None):
...
def main():
    input_path = r"/root/autodl-tmp/VIN合并数据/车表/VIN合并数据/AI-ok更新/AI -OK _总表.xlsx"
    output_dir = r"/root/autodl-tmp/VIN合并数据/车表/VIN合并数据/AI-ok更新/清洗结果"

...
我的工作不是只会跑 Demo，而是把模型能力做成**可运营的产品能力**：流程拆解、接口契约、异步任务、性能优化、失败兜底、可观测与可交付。
...
- 大型二进制文件(原 zip、Excel、模型权重)请勿上传,可使用 [Git LFS](https://git-lfs.github.com/) 单独管理。
